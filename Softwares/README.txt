...
6)	Copy all the folders located in "SRA library" directory into "~\Documents\Arduino\libraries"
...
***NOTE:While uploading DO NOT USE the upload icon in the ide use ctrl+shift+u or select the option Upload using Programmer under the "Sketch" menu.